...
public class DataDrivenFramework {
	...
	ExtentTest test;
	File screen;
	String inputpath="F:\\December_Selenium\\FrameWorks\\TestInput\\Employee.xlsx";
	String outputpath="F:\\December_Selenium\\FrameWorks\\TestOutput\\Results.xlsx";
	@BeforeTest
	...
	public void addEmployee()throws Throwable
	{
		...
		for(int i=1;i<=rc;i++)
		{
			...
			if(driver.getCurrentUrl().contains("empNumber"))
			{
				...
				xl.setcetcelldata("Emp", i, 3, "Pass", outputpath);
			}
			else
			{
...
FileUtils.copyFile(screen, new File("D:\\December_Selenium\\Selenium_Frameworks\\Screens\\"+i+"emp.png"));
				...
				xl.setcetcelldata("Emp", i, 3, "Fail", outputpath);
			}
			report.endTest(test);
			report.flush();
		}
